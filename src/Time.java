...
public class Time implements Serializable, Comparable<Time> {
	...
	public static Time inputTime() throws FailTimeException {
		...
		System.out.println("Ââåä³òü ÷àñ(ãîäèíè â ìåæàõ 0..23):");
		int hour = sc.nextInt();
		System.out.println("Ââåä³òü ÷àñ(õâèëèíè â ìåæàõ 0..59):");
		int min = sc.nextInt();
		return new Time(hour, min);
	}
...
class FailTimeException extends Exception {
	static final String string = "Ââåäåíèé ÷àñ ìàº áóòè â³ä 0 äî 24 äëÿ ãîäèí òà â³ä 0 äî 60 äëÿ õâèëèí!";
